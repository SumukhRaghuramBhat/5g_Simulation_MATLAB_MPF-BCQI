classdef hNRSchedulerBestCQI < hNRScheduler
    %hNRSchedulerBestCQI Implements best CQI scheduler

    %   Copyright 2020 The MathWorks, Inc.

    methods
        function obj = hNRSchedulerBestCQI(simParameters)
            %hNRSchedulerBestCQI Construct an instance of this class
