classdef  hNRPacketDistribution < handle
    ...
    properties
        ...
        %LinkDir Represents the link direction. Downlink (0) and Uplink (1).
        LinkDir (1, 1) {mustBeInteger, mustBeInRange(LinkDir, 0, 1)};
    ...
    methods(Access = public)
        function obj = hNRPacketDistribution(simParam, linkDir)
            ...
            %
            % LINKDIR Represents the link direction
            obj.LinkDir = linkDir;
