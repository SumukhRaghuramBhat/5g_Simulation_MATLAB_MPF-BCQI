function macPDU = hNRMACMultiplex(subPDUList, ceSubPDUList, paddingSubPDU, linkDir) %#codegen
%hNRMACMultiplex Generates an NR MAC PDU from subPDUs
%
%   Note: This is a helper function for an example.
%
%   MACPDU = hNRMACMultiplex(SUBPDULIST, CESUBPDULIST,
