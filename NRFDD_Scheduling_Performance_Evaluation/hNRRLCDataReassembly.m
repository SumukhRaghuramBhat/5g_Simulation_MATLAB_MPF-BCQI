classdef hNRRLCDataReassembly < handle
%hNRRLCDataReassembly Create an RLC SDU reassembly information object
...
% Copyright 2019-2020 The MathWorks, Inc.
    ...
    methods
        function obj = hNRRLCDataReassembly(maxSegmentGapsPerSDU)
            %hNRRLCDataReassembly Construct an RLC SDU reassembly
            % information object
        ...
        function [numDupBytes, isReassembled] = reassembleSegment(obj, sduSegment, pduLength, segmentOffset, isLastSegment)
            ...
            numNewBytes = obj.updateMissingSegmentsContext(segmentOffset, segmentLength, isLastSegment);
