function macPaddingSubPDU = hNRMACPaddingSubPDU(subPDULength) %#codegen
%hNRMACPaddingSubPDU Generates NR MAC padding subPDU
%
%   Note: This is a helper function for an example.
%
%   MACPADDINGSUBPDU = hNRMACPaddingSubPDU(SUBPDULENGTH) generates a medium
