function macSubPDU = hNRMACSubPDU(lcid, payload, linkDir) %#codegen
%hNRMACSubPDU Generates NR MAC subPDU
%
%   Note: This is a helper function for an example.
%
%   MACSUBPDU = hNRMACSubPDU(LCID, PAYLOAD, LINKDIR) generates a medium
